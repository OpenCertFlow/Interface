...
class AuthFlowIntegrationTest {
    ...
    void 토큰_없이_마이페이지에_접근할_수_없다() {
        webTestClient.get().uri("/api/v1/me")
                ...
                .jsonPath("$.error.code").isEqualTo("OCF-AUTH-007");
    }
    ...
    void 같은_이메일로_두_번_가입할_수_없다() {
        ...
        webTestClient.post().uri("/api/v1/auth/signup")
                ...
                .expectBody()
                .jsonPath("$.error.code").isEqualTo("OCF-AUTH-001");
    }
    ...
    void 잘못된_자격증명은_동일한_오류를_준다() {
        ...
        webTestClient.post().uri("/api/v1/auth/login")
                ...
                .exchange()
                .expectStatus().isBadRequest()
                .expectBody().jsonPath("$.error.code").isEqualTo("OCF-AUTH-002");
    ...
    void 다중_세션은_서로_독립적이다() {
        ...
        webTestClient.post().uri("/api/v1/auth/refresh")
                ...
                .exchange()
                .expectStatus().isBadRequest()
                .expectBody().jsonPath("$.error.code").isEqualTo("OCF-AUTH-008");
    ...
    void 이메일_인증_코드로_인증을_완료한다() {
        ...
        webTestClient.post().uri("/api/v1/auth/email/verify")
                ...
                .exchange()
                .expectStatus().isBadRequest()
                .expectBody().jsonPath("$.error.code").isEqualTo("OCF-AUTH-004");
