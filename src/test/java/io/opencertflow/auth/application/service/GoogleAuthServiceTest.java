...
import io.opencertflow.auth.application.port.in.GoogleLoginUseCase.GoogleLoginCommand;
...
class GoogleAuthServiceTest {
    ...
    void setUp() {
        ...
        IdGenerator idGenerator = io.opencertflow.support.TestIds::next;
    ...
    void 기존_계정은_다시_만들지_않는다() {
        User existing = User.registerGoogle(
                UserId.of(io.opencertflow.support.TestIds.next()), Email.of("user@gmail.com"),
