...
class JwtTokenProviderTest {
    ...
    private static final String SECRET = "opencertflow-test-secret-key-at-least-32-bytes-long";
    ...
    private static AuthProperties properties(String secret) {
        return new AuthProperties(
                new AuthProperties.Jwt(secret, 1800, 1_209_600, "opencertflow"),
                new AuthProperties.Kakao("id", "secret", "uri", "token", "userinfo"),
                new AuthProperties.Google("id", "secret", "uri", "token", "userinfo"),
