package io.opencertflow.document;
...
class DocumentFlowIntegrationTest {
    ...
    static void properties(DynamicPropertyRegistry registry) {
        ...
        registry.add("opencertflow.file.storage-root", () -> uploadRoot.toString());
    }
    ...
    void 필수_항목이_비면_거부한다() {
        ...
        Map<String, String> missing = Map.of("companyName", "OpenCertFlow");
        ...
        webTestClient.post().uri("/api/v1/documents/issues")
                ...
                .expectBody().jsonPath("$.error.code").isEqualTo("OCF-DOC-002");
    }
    ...
    void 발급_이력은_본인_것만_보인다() {
        ...
        webTestClient.get().uri("/api/v1/documents/issues/{id}", documentId)
                ...
                .exchange()
                .expectStatus().isEqualTo(409)
                .expectBody().jsonPath("$.error.code").isEqualTo("OCF-DOC-006");
        ...
        webTestClient.get().uri("/api/v1/documents/issues/{id}", documentId)
                ...
                .exchange()
                .expectStatus().isOk()
                .expectBody().jsonPath("$.data.values.companyName").isEqualTo("OpenCertFlow");
    }
