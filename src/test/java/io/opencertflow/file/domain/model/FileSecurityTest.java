...
class FileSecurityTest {
    ...
    class DeletePermission {
        ...
        private StoredFile fileOwnedBy(OwnerRef owner) {
            return StoredFile.register(
                    FileId.of(io.opencertflow.support.TestIds.next()),
        ...
        void 업로더는_지울_수_있다() {
            OwnerRef owner = OwnerRef.of(io.opencertflow.support.TestIds.next());
        ...
        void 남의_파일은_지울_수_없다() {
            StoredFile file = fileOwnedBy(OwnerRef.of(io.opencertflow.support.TestIds.next()));

            assertThatThrownBy(() -> file.requireDeletableBy(OwnerRef.of(io.opencertflow.support.TestIds.next()), false))
                    .isInstanceOf(BusinessException.class);
        }
        ...
        void 관리자는_남의_파일도_지운다() {
            ...
            assertThatCode(() -> file.requireDeletableBy(OwnerRef.of(io.opencertflow.support.TestIds.next()), true))
                    .doesNotThrowAnyException();
        }
    }
    ...
    void 빈_파일은_거부한다() {
        assertThatThrownBy(() -> StoredFile.register(
                ...
                OwnerRef.of(io.opencertflow.support.TestIds.next()),
                Visibility.PUBLIC,
                Instant.parse("2026-08-10T12:00:00Z")))
                .isInstanceOf(BusinessException.class);
    }
