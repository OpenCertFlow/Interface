...
import io.opencertflow.diagnosis.application.port.in.ManageRuleSetUseCase.ConsistencyIssue;
import io.opencertflow.diagnosis.application.port.out.RuleDefinitionValidatorPort;
import io.opencertflow.diagnosis.application.port.out.RuleDefinitionValidatorPort.Definition;
import io.opencertflow.diagnosis.application.port.out.RuleDefinitionValidatorPort.Issue;
import io.opencertflow.diagnosis.application.port.out.RuleSetAdminPort;
import io.opencertflow.diagnosis.application.port.out.RuleSetAdminPort.NewRule;
import io.opencertflow.diagnosis.application.port.out.RuleSetAdminPort.NewRuleSet;
