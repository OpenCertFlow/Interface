...
import io.opencertflow.diagnosis.application.port.in.GetProductGroupSchemaUseCase;
import io.opencertflow.diagnosis.application.port.in.ManageProductGroupQuestionUseCase;
import io.opencertflow.diagnosis.application.port.out.ProductGroupSchemaPort;
import io.opencertflow.diagnosis.application.port.out.ProductGroupSchemaPort.OverridePatch;
import io.opencertflow.diagnosis.application.port.out.ProductGroupSchemaPort.QuestionOverride;
import io.opencertflow.diagnosis.domain.model.InputField;
