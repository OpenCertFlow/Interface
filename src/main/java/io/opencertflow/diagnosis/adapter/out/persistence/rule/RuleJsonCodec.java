...
import io.opencertflow.diagnosis.domain.rule.Operator;
import io.opencertflow.diagnosis.domain.rule.RequireDocument;
import io.opencertflow.diagnosis.domain.rule.ValueKind;
...
public class RuleJsonCodec {
    ...
    private Object coerceScalar(ValueKind kind, JsonNode node) {
        return switch (kind) {
            ...
            case APPLIANCE_ITEM -> enumValue(ApplianceItem.class, node.asText());
