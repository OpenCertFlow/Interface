...
import io.opencertflow.diagnosis.application.port.in.ManageProductGroupQuestionUseCase.Option;
import io.opencertflow.diagnosis.application.port.in.ManageProductGroupQuestionUseCase.QuestionAdminView;
 ...
 */
@Tag(name = "관리자 · 제품군 질문", description = "제품군별 입력 항목 재정의")
@WebAdapter
