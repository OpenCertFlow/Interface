...
public class SecurityConfig {
    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        return http
                ...
                .authorizeExchange(exchanges -> exchanges
                        ...
                        // 진단 초안(F-APP-004)·이력(F-APP-032/034/035)은 본인만 — permitAll 규칙보다 먼저 둔다
                        ...
                        .pathMatchers(HttpMethod.GET, "/api/v1/diagnoses/*/input").authenticated()
                        ...
                        // 룰셋 조회(근거·Rule 상세). 편집은 /admin/rule-sets(ADMIN), 조회는 컨설턴트도 가능
                        .pathMatchers(HttpMethod.GET, "/api/v1/rule-sets/**").hasAnyRole("CONSULTANT", "ADMIN")
    ...
    private Mono<Void> writeError(
        ...
        String traceId = exchange.getResponse().getHeaders()
                .getFirst(io.opencertflow.common.adapter.in.web.trace.TraceId.HEADER);
        ApiResponse<Void> body = ApiResponse.failure(
                ErrorResponse.of(errorCode.code(), errorCode.defaultMessage()),
                traceId != null ? traceId : io.opencertflow.common.adapter.in.web.trace.TraceId.UNKNOWN,
                timeProvider.now());
