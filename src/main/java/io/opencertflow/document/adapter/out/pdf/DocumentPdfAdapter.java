package io.opencertflow.document.adapter.out.pdf;

import io.opencertflow.common.adapter.out.pdf.KoreanPdfWriter;
import io.opencertflow.common.adapter.out.pdf.PdfDocument;
import io.opencertflow.document.application.port.out.RenderDocumentPdfPort;
...
public class DocumentPdfAdapter implements RenderDocumentPdfPort {
    ...
    private static final String DRAFT_NOTICE =
            "본 문서는 OpenCertFlow가 생성한 작성 보조용 초안입니다. 제출 전 반드시 담당 기관·전문가의 "
