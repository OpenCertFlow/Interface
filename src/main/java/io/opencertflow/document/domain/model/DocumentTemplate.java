...
import static io.opencertflow.document.domain.model.FieldType.DATE;
import static io.opencertflow.document.domain.model.FieldType.MULTILINE;
import static io.opencertflow.document.domain.model.FieldType.NUMBER;
import static io.opencertflow.document.domain.model.FieldType.TEXT;
...
public enum DocumentTemplate {
    ...
    SELF_DECLARATION(
            ...
            List.of(
                    FormField.required("companyName", "업체명", TEXT, "예: OpenCertFlow"),
